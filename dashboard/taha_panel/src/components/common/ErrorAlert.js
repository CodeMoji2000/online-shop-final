...
const ErrorAlert = ({ errors, open, handleClose }) => {
  ...
  return (
    <div
      className={`tw-absolute tw-z-20 tw-bottom-0 ${
        bounce ? "tw-animate-pulse" : ""
      } ${
        errorCount != 0 ? "tw-block" : "tw-hidden"
      } tw-inset-x-1 lg:tw-inset-x-96 rtl tw-py-8 tw-shadow-lg alert alert-danger alert-dismissible fade show  ${
